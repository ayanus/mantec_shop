...
<body> 
    <form class="form-signin" action="register_db.php" method="post">
        ...
        <div class="wrapper">
            ...
            <h4 class="form-signin-heading text-center fw-bold">สมัครสมาชิก</h4>
            ...
            <div class="input-group mb-3 mt-4">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="password" name="password_1" class="form-control" id="floatingInputGroup1" placeholder="password">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="password" name="password_2" class="form-control" id="floatingInputGroup1" placeholder="password">
