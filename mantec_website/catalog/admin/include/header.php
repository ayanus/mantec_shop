                    ...
                    <a class="app-logo" href="../admin/index.php"><img class="logo-icon me-2" src="assets/images/logo.png" alt="logo"><span class="logo-text">ระบบแคตล็อก</span></a>
                        ...
                        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                                <li class="nav-item">
                                    <a class="nav-link <?php echo !isset($_GET['page']) && empty($_GET['page']) ? 'active' : '' ?>" href="../admin/index.php">
                                        <span class="nav-icon">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo isset($_GET['page']) && ($_GET['page']) == 'company' ? 'active' : '' ?>" href="?page=company">
                                        <span class="nav-icon">
                                        ...
                                        <span class="nav-link-text">จัดการข้อมูลบริษัท</span>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link <?php echo isset($_GET['page']) && ($_GET['page']) == 'contact' ? 'active' : '' ?>" href="?page=contact">
                                        <span class="nav-icon">
                                        ...
                                        <span class="nav-link-text">จัดการช่องทางการติดต่อ</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo isset($_GET['page']) && ($_GET['page']) == 'admin' ? 'active' : '' ?>" href="?page=admin">
                                        ...
                                        <span class="nav-link-text">จัดการข้อมูลผู้ใช้งานระบบ</span>
                                    </a>
                                </li>
                            </ul>
                        </nav>
