...
// Query Product
$sql = "SELECT * ,p.id,p.name,tp.title AS type 
FROM sp_product p 
...
<head>
  ...
  <!-- <link rel="stylesheet" href="toastBox.css"> -->
    ...
    <div class="container">
      <div class="sidebar">
        ...
        <?php foreach ($query_type_product as $data): ?>
          <a onclick="searchproduct('<?= $data['title'] ?>')" class="sidebar-items"><?= $data['title'] ?></a>
        <?php endforeach; ?>
      </div>
    ...
    <div class="modal-page">
      ...
      <div class="modaldesc-content">
        ...
        <div class="modaldesc-detail">
          ...
          <br>
          <p id="mdd-type" style="font-size: 1.5vw;"></p>
          <div class="btn-control">
            <button onclick="closeModal()" class="btn">Close</button>
            <button onclick="addtocart()" class="btn btn-buy">Add to cart</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="modalCart" class="modal" style="display: none;">
    ...
    <div class="modal-page">
      ...
      <div class="btn-control">
        ...
        <button onclick="buynow()" class="btn btn-buy">Buy</button>
      </div>
    </div>
  </div>
